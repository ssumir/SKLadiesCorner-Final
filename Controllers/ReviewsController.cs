...
namespace SKLadiesCorner.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ReviewId,ProductId,UserId,Rating,ReviewText,ReviewDate,IsApproved")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReviewId,ProductId,UserId,Rating,ReviewText,ReviewDate,IsApproved")] Review review)
        {
